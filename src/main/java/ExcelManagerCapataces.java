...
public class ExcelManagerCapataces {
    ...
    public ExcelManagerCapataces() {
        ...
        System.out.println("Introduce el nombre del Excel de APOYOS con el que quieres trabajar:\n");
        ...
        System.out.println("Introduce el nombre de la hoja del Excel de APOYOS con la que quieres trabajar (línea de la que quieres que se cree el control de capataces):\n");
    ...
    private HashMap leerDatosCapataces() {
        ...
        for (int i = 2; i < numFilas; i++) {
            ...
            if (fila != null && fila.getCell(0) != null) {
                 ...
                 * N DIAS TRABAJADOS
                 */
                capatazAnyadir.setNumDiasTrabajados(fila.getCell(10).getNumericCellValue());
    ...
    public void creacionExcelControlCapataces(String nombreExcel, String zona, String codLinea) {
        ...
        for (int i = 0; i < listaCapatacesLinea.size() ;i++) {
            ...
            introducirValoresCapataz(hoja, zona, codLinea, nombreHoja);
        }
        try {
